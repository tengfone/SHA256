            ...
            <div className="flex flex-row flex-wrap py-10 justify-center">
                <div className="px-4 py-3 rounded-lg xl:w-7/12 shadow p-4 flex">
                    ...
                    <form className="w-full inline-flex" onSubmit={handleSubmit}>
                        <input id='encodeText' name='encodeText' onChange={(e) => setText(e.target.value)} type="text" className="w-full rounded p-2" placeholder="Type In Anything" />
                        <button type="submit" className="bg-blue-300 hover:bg-blue-100 rounded text-white p-2 pl-4 pr-4">
                            <p className="font-semibold text-xl">Encode</p>
                        </button>
                    </form>
                </div>
            </div>
                ...
                <div className="flex flex-row flex-wrap py-10 justify-center">
                    <div className="shadow items-center px-4 py-3 text-green-700 bg-green-100 rounded-lg xl:w-7/12 flex" role="alert">
                        <div className="w-5/6">
                            ...
                            <p className="break-all">{encodeText}</p>
                        </div>
                        <div className="w-1/6">
                ...
                copied && (
                    <div className="flex flex-row flex-wrap py-10 justify-center">
                        <div class="py-3 px-5 mb-4 bg-blue-100 text-blue-900 text-sm rounded-md border border-blue-200 flex items-center justify-between" role="alert">
                            <span>Copied</span>
                            <button class="w-4" type="button" data-dismiss="alert" aria-label="Close" onClick={() => { setCopied(false) }}>
